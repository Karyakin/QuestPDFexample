                    ...
                    grid.Item(10)
                        ...
                        .Table(table =>
                        {
                            table.ColumnsDefinition(columns =>
                            {
                                ...
                                table.Cell().ExtendHorizontal().AlignLeft().Text("В том числе НДС по ставке").Light();
                                table.Cell().ExtendHorizontal().AlignLeft().Text("200%");
                                table.Cell().ExtendHorizontal().AlignLeft().Text("0,02 BYN ( ноль ) белорусских рублей 02 копейки");
                            });
                        });
